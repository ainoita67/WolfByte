...
class PortatilService
{
   ...
   /**
    ...
    public function checkDisponibilidad(array $input): array
    {
        ...
        if (strtotime($data['inicio']) <= strtotime($data['f_creacion'])) {
            throw new ValidationException(["No se puede hacer una reserva en el pasado"]);
        }
