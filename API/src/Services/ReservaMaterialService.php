...
use Models\ReservaMaterialModel;
...
{
    private ReservaMaterialModel $model;

    public function __construct()
    {
        $this->model = new ReservaMaterialModel();
    }
    ...
    // Devuelve todas las reservas de un material específico
    public function getReservasPorMaterial($idMaterial): array
    {
        Validator::validate(['id' => $idMaterial], [
