...
class MaterialModel
{
    ...
    public function getCarritosDisponibilidad($inicio, $fin, $dia_semana, $hora_inicio, $hora_fin): array
    {
        ...
        //                     WHERE re.tipo='Reserva_material' AND m.id_material=:material1
        //                     AND ((re.inicio>:fin1 AND re.fin<:inicio1)
        //                     OR (re.inicio=:inicio2 AND re.fin=:fin2))
        ...
        //             JOIN Edificio ed ON ed.id_edificio=r.id_edificio
        //             JOIN Planta p ON p.numero_planta=r.numero_planta AND p.id_edificio=ed.id_edificio
        ...
        //                 r.id_recurso
        //         ")
        //         ->bind(':diasemana', $dia_semana)
        //         ->bind(':horainicio1', $hora_inicio)
        //         ->bind(':horafin1', $hora_fin)
        //         ->bind(':horainicio2', $hora_inicio)
        //         ->bind(':horafin2', $hora_fin)
        //         ->bind(':inicio1', $inicio)
        //         ->bind(':fin1', $fin)
        //         ->bind(':inicio2', $inicio)
        //         ->bind(':fin2', $fin)
