...
<html lang="es">
    ...
    <body class="container-fluid">
                ...
                <ul class="col-12 d-none d-lg-grid text-center fs-5 pt-3">
                    ...
                    <li class="list-group-item pt-5 pb-5 d-none d-lg-block" id="perfil"><a href="#" id="menudesplegable"  data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-person-circle fs-1"></i></a>
                        <ul class="dropdown-menu" data-target="#menudesplegable">
                            <a href="#" ><li class="dropdown-item">Mis datos</li></a>
                            <a href="#" ><li class="dropdown-item">Mis reservas</li></a>
        ...
        <main class="pt-5 row justify-content-center align-items-center main-content">
            <div class="col-11 col-sm-8 col-md-6 col-lg-4">
                <div class="card shadow p-4 text-center">
                    ...
                    <div class="d-flex justify-content-center gap-5 mb-3">
                        <a href="#" class="btn btn-primary px-4">Mis reservas</a>
                        <a href="#" class="btn btn-primary px-4">Mis incidencias</a>
                    </div>

                    <a href="#" class="btn btn-success px-4">Menú principal</a>
                </div>
            </div>
        </main>
        <!-- Bootstrap JS -->
