...
<main class="container-fluid menu row text-center">
    <a href="administrador/usuarios.html" class="menu col-lg-3 mx-lg-5 p-5 fs-5">Usuarios</a>
    <a href="administrador/logacciones.html" class="menu col-lg-3 mx-lg-5 p-5 fs-5">Log de acciones</a>
    <a href="administrador/aulasyespacios.html" class="menu col-lg-3 mx-lg-5 p-5 fs-5">Aulas y espacios</a>
    <a href="administrador/reservaspermanentes.html" class="menu col-lg-3 mx-lg-5 p-5 fs-5 mb-lg-0">Reservas permanentes</a>
    <a href="administrador/materiales.html" class="menu col-lg-3 mx-lg-5 p-5 fs-5 mb-lg-0">Materiales</a>
    <a href="administrador/tablasauxiliares.html" class="menu col-lg-3 mx-lg-5 p-5 fs-5 mb-lg-0">Tablas auxiliares</a>
