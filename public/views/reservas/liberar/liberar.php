...
<main class="container mt-5">
    ...
    <div class="card p-5 shadow-sm">
        ...
        <form class="row g-4">
            ...
            <div class="col-md-6">
                <button type="submit" class="btn w-100 py-2 enviar text-light">Liberar</button>
            </div>

            <div class="col-md-6">
                <a href="/public/views/menu.php" class="btn bg-lightgrey w-100 py-2 text-dark">Volver</a>
            </div>
