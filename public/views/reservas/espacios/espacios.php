...
<main class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="text-center mb-4">Espacios deportivos</h2>
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered align-middle text-center tabla-cabecera">
            ...
            <tbody>
                <tr>
                    <th class="bg-azul text-light">Pistas</th>
                    <td>Pista azul, Pista roja</td>
                    <td>-</td>
                </tr>
                <tr>
                    <th class="bg-azul text-light">Gimnasio</th>
                    <td>-</td>
                    <td>Gimnasio principal, Sala fitness</td>
                </tr>
                <tr>
                    <th class="bg-azul text-light">Pabellón</th>
                    <td>-</td>
                    <td>Pabellón cubierto</td>
                </tr>
                <tr>
                    <th class="bg-azul text-light">Campos</th>
                    <td>Campo fútbol, Pista atletismo</td>
                    <td>-</td>
                </tr>
            </tbody>
        </table>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Filtrar espacios deportivos</h5>
                ...
                <form class="row px-2">
                    ...
                    <div class="mb-3 col-6 col-lg-4">
                        ...
                        <select class="form-control" id="espacio" name="espacio">
                            <option value="" selected disabled>Seleccionar espacio</option>
                            <option>Pista azul</option>
                            <option>Pista roja</option>
                            <option>Gimnasio principal</option>
                            <option>Sala fitness</option>
                            <option>Pabellón cubierto</option>
                            <option>Campo fútbol</option>
                            <option>Pista atletismo</option>
                        </select>
                    </div>

                    <div class="mb-3 col-6 col-lg-4">
                        <label for="capacidad">Capacidad</label>
                        <input type="number" min="0" max="200" value="30" class="form-control" id="capacidad" name="capacidad">
                    </div>

                    <div class="mb-3 col-6 col-lg-4">
                        <label for="tipo">Tipo</label>
                        <select class="form-control" id="tipo" name="tipo">
                            <option value="" selected disabled>Interior / Exterior</option>
